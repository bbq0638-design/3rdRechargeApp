    ...
    return (
        <View style={styles.header}>
            ...
            <View style={styles.right}>
                <>
                    ...
                    <IconButton
                        ...
                        color="#585858ff"
                        style={{ marginRight: -2 }}
                        onPress={() => navigation.navigate('NoticeStack', { screen: 'NoticeMain' })}
                    />
                    {/* 알림 */}
                    ...
                    <IconButton
                        ...
                        size={24}
                        color="#585858ff"
                        onPress={() => navigation.navigate('SettingStack', { screen: 'SettingMain'})}
            ...
            <DropdownModalKSA
                ...
                options={notiOptions.length > 0? notiOptions : [{label: '새로운 알림이 없습니다.', value: null}]}     
                selectedValue={null}
                onSelect={(item) => {
                    if (item.value) {
